...
if (isset($_GET['id'])) {
  ...
  $data = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM penerbit WHERE id_penerbit = '$id'"));
}
...
if (isset($_POST['update'])) {
  ...
  mysqli_query($koneksi, "UPDATE penerbit SET nama='$nama', alamat='$alamat', kota='$kota', telepon='$telepon' WHERE id_penerbit='$id'");
...
<div class="container my-5 fade-in">
  <h3 class="text-center text-primary fw-bold mb-4">Edit Data Penerbit</h3>
